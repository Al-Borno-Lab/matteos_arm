...
register_env_with_variants(id='CenterReachOut-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=100,
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachout.xml',
                               'normalize_act': True,
                               'obj_xyz_range': [[0.47,0.17,.075], [0.5407,0.1407,.075], [0.57,0.07,.075], [0.5407,-0.0007,.075], [0.47,-0.03,.075], [0.3993,-0.0007,.075], [0.37,0.07,.075], [0.3993,0.1407,.075]],
                               # xyz: neg x, neg y and positive z(around 1)
                               'far_th': 0.15
                           }
                           )

register_env_with_variants(id='CenterReachOutMuscle-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=300,
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachoutbi1.xml',
                               'normalize_act': True,
                               'obj_xyz_range': [[0.47,0.22,.075],[0.5761,0.1761,.075],[0.62,0.07,.075],[0.5761,-0.0361,.075],[0.47,-0.08,.075],[0.3639,-0.0361,.075],[0.32,0.07,.075],[0.3639,0.1761,.075]],
                               # xyz: neg x, neg y and positive z(around 1)
                               'far_th': 0.15
                           }
                           )

register_env_with_variants(id='CenterReachOutBi-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=300,
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachoutbi1.xml',
...
register_env_with_variants(id='CenterReachOut1-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=40, # make 100 or goal of 40-50 timesteps
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachoutbi1.xml',
                               'normalize_act': True,
                               'obj_xyz_range': [[0.552548,0.0,.075]],
                               # xyz: neg x, neg y and positive z(around 1)
                               'far_th': 0.15
                           }
                           )

register_env_with_variants(id='CenterReachOut2-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=40,
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachoutbi1.xml',
                               'normalize_act': True,
                               'obj_xyz_range': [[0.523259,-0.070711,.075]],
                               # xyz: neg x, neg y and positive z(around 1)
                               'far_th': 0.15
                           }
                           )

register_env_with_variants(id='CenterReachOut3-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=40,
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachoutbi1.xml',
                               'normalize_act': True,
                               'obj_xyz_range': [[0.452548,-0.1,.075]],
                               # xyz: neg x, neg y and positive z(around 1)
                               'far_th': 0.15
                           }
                           )

register_env_with_variants(id='CenterReachOut4-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=40,
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachoutbi1.xml',
                               'normalize_act': True,
                               'obj_xyz_range': [[0.381837,-0.70711,.075]],
                               # xyz: neg x, neg y and positive z(around 1)
                               'far_th': 0.15
                           }
                           )

register_env_with_variants(id='CenterReachOut5-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=40,
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachoutbi1.xml',
                               'normalize_act': True,
                               'obj_xyz_range': [[0.352548,0,.075]],
                               # xyz: neg x, neg y and positive z(around 1)
                               'far_th': 0.15
                           }
                           )

register_env_with_variants(id='CenterReachOut6-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=40,
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachoutbi1.xml',
                               'normalize_act': True,
                               'obj_xyz_range': [[0.381837,0.070711,.075]],
                               # xyz: neg x, neg y and positive z(around 1)
                               'far_th': 0.15
                           }
                           )

register_env_with_variants(id='CenterReachOut7-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=40,
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachoutbi1.xml',
...
register_env_with_variants(id='CenterReachOut8-v0',
                           entry_point='myosuite.envs.myo.myobase.CenterReachOutBi_v0:ReachEnvV0',
                           max_episode_steps=40,
                           kwargs={
                               'model_path': curr_dir + '/../assets/arm/myoarm_centerreachoutbi1.xml',
